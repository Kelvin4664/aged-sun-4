"""
Django settings for aged_sun_4 project.
...
WSGI_APPLICATION = 'aged_sun_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_sun_4 API",
    "DESCRIPTION": "API documentation for aged_sun_4 App",
    "VERSION": "v1",
}
